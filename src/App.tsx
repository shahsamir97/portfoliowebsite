...
import profilePic from "./profilePicture.jpeg";
...
const SERVICES = [
  {
    ...
    price: "€35/hr",
    description:
      "Flexible development support for your existing projects or new features.",
  ...
  },
  {
    ...
    price: "€20/hr",
    description:
      "Expert advice on mobile architecture, tech stack, and project planning.",
  ...
  },
  {
    ...
    price: "Custom Quote",
    description:
      "End-to-end development with my remote team of expert developers.",
...
const PROCESS_STEPS = [
  {
    ...
    desc: "Gathering all your ideas and needs.",
  },
  {
    title: "Requirement Analysis",
    desc: "Deep dive into technical feasibility.",
  },
...
const PROJECTS = [
  {
    title: "Make My Meal",
    description:
      "AI-powered cooking assistant that generates recipes from food photos using Gemini API.",
  ...
  },
  {
    title: "E-Shop",
    description:
      "Full-featured e-commerce Android app with merchant and customer portals.",
  ...
  },
  {
    title: "IELTS 360",
    description:
      "Band score calculator with Firebase integration for progress tracking.",
  ...
  },
  {
    title: "Mood Today",
    description:
      "Mood-check quiz app using Gemini API for analysis and BLoC for state management.",
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900 relative overflow-x-hidden">
      {/* Global Tech Background */}
      <div className="fixed inset-0 bg-dot-slate-200 pointer-events-none -z-20" />
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <ScrollLink
            to="hero"
            smooth={true}
            className="text-xl font-bold cursor-pointer tracking-tighter text-blue-600"
          >
            PORTFOLIO
          </ScrollLink>
      ...
      >
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-5 hidden lg:block">
            <motion.div
              animate={{ y: [0, -100] }}
              transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
              className="absolute top-20 left-10 font-mono text-sm"
            >
              <pre>{`class AndroidEngineer {\n  val skills = listOf("Kotlin", "Compose")\n}`}</pre>
            </motion.div>
            <motion.div
              animate={{ y: [0, -150] }}
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
              className="absolute bottom-40 right-20 font-mono text-sm"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-xl leading-relaxed">
              ...
              . A results-driven Android & Full-stack Engineer with 4+ years of
              experience delivering production-ready features for 1M+ users.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  className="p-3 bg-white border border-slate-200 rounded-full hover:border-blue-600 hover:text-blue-600 transition-all"
                >
                  <Github className="w-6 h-6" />
                </a>
                <a
                  href="https://www.linkedin.com/in/md-shah-samir-83639b54/"
                  target="_blank"
                  className="p-3 bg-white border border-slate-200 rounded-full hover:border-blue-600 hover:text-blue-600 transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              A battle-tested workflow to take your idea from concept to a
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((item) => (
                    <span
                      key={item}
                      className="px-3 py-1.5 bg-slate-50 text-slate-600 rounded-xl text-sm font-medium border border-slate-100"
                    >
                      {item}
                    </span>
                  ))}
      ...
      <section className="py-24 bg-blue-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-blue-100 mb-12 leading-relaxed">
            Whether you need a quick bug fix, a new feature, or a complete MVP
            for your startup, I'm here to help you build something amazing.
          </p>
      ...
      <footer className="py-12 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            <p className="text-xl font-bold text-blue-600 uppercase tracking-tighter">
              Portfolio
            </p>
            <p className="text-slate-500 text-sm mt-2">
              © 2026 Mohammad Shah Samir. All rights reserved.
            </p>
          </div>
